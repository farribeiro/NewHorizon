...
local function get_armor_formspec(player_name)
    ...
    local formspec = "size[9,9.5]" ..
        ...
        "label[3.5,3.8;Cintura]" .. "list[current_player;armor_waist;3.5,3.8;1,1;]"
    if has_backpack then
        formspec = formspec .. "list[current_player;main;0.5,5.7;8,2;8]" .. "list[current_player;main;0.5,7.9;8,1;]"
    else
